...
//
//  Model identification only. Screen geometry (cutout, corner radii) lives in
//  `ScreenHardware`; views read it through `LayoutContext`.
//
...
extension UIDevice {
  ...
  static var normalizedModelName: String {
