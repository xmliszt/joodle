...
struct FujifilmGrade {
  ...
  static let classicNegative = FujifilmGrade(
    temperatureK: 7336.94,
    tint: -0.684685,
    saturation: 0.748829,
    contrast: 1.04937,
    brightness: -0.0127027,
    vibrance: 0.317837,
    highlightAmount: 0.724325,
    shadowAmount: 0.00900865,
    ...
    bloomRadius: 0,
    softFocusAmount: 0,
    grainAmount: 0.165226,
    grainScale: 0.1,
    grainChroma: 0,
    vignetteIntensity: 0.19027,
    vignetteRadius: 1.8,
    selectiveColor: SelectiveColor(bands: [
      .init(hueShiftDegrees: 0, saturationScale: 1, luminanceScale: 1),
      .init(hueShiftDegrees: 0, saturationScale: 1, luminanceScale: 1),
      .init(hueShiftDegrees: -1.40541, saturationScale: 1, luminanceScale: 1),
